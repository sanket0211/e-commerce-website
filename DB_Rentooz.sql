...
--
-- Host: localhost
-- Generation Time: Dec 30, 2015 at 06:54 AM
...
INSERT INTO `Deals` (`deal_id`, `b_id`, `g_id`, `item_id`, `status`, `no_of_days`, `b_reviewed`, `g_reviewed`) VALUES
(1, 2, 1, 1, 5, 10, 0),
(2, 2, 1, 2, 2, 2, 0);
...
INSERT INTO `Items` (`Item_id`, `user_id`, `community_id`, `item_name`, `item_desc`, `item_category_id`, `item_end_date`, `item_status`, `item_rent`, `item_img_name`, `item_img_ext`, `item_thumb_name`) VALUES
(1, 1, 2, 'Calculator', '<strong>Casio</strong> ka', 64, '2015-12-28', 0, 10, 'cla', '.jpeg', 'cla_thumb'),
(2, 1, 4, 'belt', 'leather belt', 22, '2015-12-29', 1, 20, 'belt', '.jpeg', 'belt_thumb');
...
INSERT INTO `Users` (`user_id`, `user_name`, `user_fname`, `user_lname`, `user_password`, `user_phone`, `user_email`, `city_id`, `user_img_name`, `user_img_ext`, `user_thumb_name`, `referral_code`, `user_coins`, `user_earnings`, `offset`, `password_reset_hash`, `joined_date`, `ads_limit`, `days_limit`, `sharentoozbonus`) VALUES
...
(2, 'Shivang Nagaria', 'shivang', 'nagaria', '$2y$10$W25YHJNIuGIqgZg951Eb1uJ637VeyF/IiIncO3kxlMDbQdy98JY.i', '9703531305', 'shivang.nagaria@gmail.com', 1, 'shivang', '.jpg', 'shivang', 'Shiv30', 200, 0, 140, '', '2015-12-07 19:03:53', 5, 0, 0),
...
INSERT INTO `verify_user` (`user_id`, `user_phone_otp`) VALUES
(15, 3749);
...
ADD UNIQUE INDEX idx_name (deal_id, item_id, user_id);
